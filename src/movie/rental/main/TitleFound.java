...
public class TitleFound extends JFrame{

	Controller controller;
	
	public TitleFound(Controller controller, String title) {
	...
	private void attributesSetter() {
        ...
        this.setTitle("Movie Titles List");
	...
	private void components(String title) {
		...
		goBack.setActionCommand("go_back_archive_from_found_title");
		
		JButton rent = new JButton("Proceed rent");
		rent.addActionListener((ActionListener) controller);
		rent.setActionCommand("proceed_rent_from_title_found");
